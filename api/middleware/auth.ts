// FIX: Use named imports from express to avoid conflicts with global DOM types like `Request`.
// FIX: Changed to named imports to resolve type conflicts with global DOM types, ensuring AuthRequest inherits properties correctly.
