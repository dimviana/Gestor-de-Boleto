            ...
            config: {
                ...
                responseSchema: {
                    ...
                    properties: {
                        ...
                        documentDate: { type: Type.STRING, description: 'The document creation date (Data do Documento). Find the date near this label, even if formatting contains errors (e.g., spaces instead of slashes). Return in YYYY-MM-DD format. Should be null if not found.' },
