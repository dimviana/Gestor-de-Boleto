...
const pt = {
    ...
    uploadHint: 'Arquivos PDF (múltiplos são permitidos)',
    ...
    extractionMethodAI: 'Python (PyMuPDF)',
    extractionMethodAIDescription: 'Extração de alta precisão usando Python para analisar o conteúdo textual do PDF. Executado no servidor.',
...
const en: typeof pt = {
    ...
    uploadHint: 'PDF files (multiple allowed)',
    ...
    extractionMethodAI: 'Python (PyMuPDF)',
    extractionMethodAIDescription: 'High-accuracy extraction using Python to analyze the PDF text content. Runs on the server.',
    extractionMethodRegex: 'REGEX (Local)',
