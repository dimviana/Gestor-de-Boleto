...
const pt = {
    ...
    monitorFolderButton: 'Monitorar Pasta no Servidor',
    monitoringFolderLabel: 'Pasta Monitorada no Servidor:',
...
const en: typeof pt = {
    ...
    monitorFolderButton: 'Monitor Server Folder',
    monitoringFolderLabel: 'Monitored Server Folder:',
